                    ...
                    <div className="grid gap-6">
                        <div className="flex items-start lg:justify-between lg:items-center flex-col lg:flex-row gap-5">
                            <div className="grid gap-2 w-full sm:w-72">
                                ...
                                <img src={avatarPreview ? `${avatarPreview}` : `./vite.svg`} alt="avatar" className="h-auto sm:w-72 rounded-2xl" />
                            ...
                            <div className="grid gap-2 w-full sm:w-72">
                                ...
                                <Link to={user && user.resume && user.resume.url} target="_blank">
                                    <img src={resumePreview ? resumePreview : "./vite.svg"} alt="resume" className="w-full h-auto sm:w-72 rounded-2xl" />
                                </Link>
                                <div className="relative">
