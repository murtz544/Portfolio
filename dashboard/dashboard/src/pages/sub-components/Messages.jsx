...
import { clearAllMessageErrors, deleteMessages, getAllMessages, resetMessageSlice } from "@/store/slices/messagesSlice";
                                        ...
                                        messages.map(element => {
                                            return(
                                                <Card key={element._id} className="grid gap-2">
                                                    ...
                                                    <CardDescription className="text-slate-950">
                                                        <span className="font-bold mr-2">Messgae:</span>
                                                        {element.message}
                                                    </CardDescription>
