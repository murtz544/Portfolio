          ...
          <TabsContent>
            <Card>
              ...
              <CardContent className="grid sm:grid-cols-2 gap-4">
                {
                  skills && skills.length > 0 ? (skills.map(element => {
                    return(
                      <Card key={element._id}>
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Trash2 onClick={()=>handleDeleteSkill(element._id)} className="h-5 w-5 hover:text-red-600"></Trash2>
                              </TooltipTrigger>
                        ...
                        <CardFooter>
                          ...
                          <Input type="number" defaultValue={element.proficiency} onChange={(e) => handleInputChange(e.target.value)} onBlur={() => handleUpdateSkill(element._id)}></Input>
                        </CardFooter>
                      </Card>
                    )
                  })) : (
