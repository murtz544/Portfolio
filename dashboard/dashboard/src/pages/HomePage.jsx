  ...
  return(
    <>
      <div className='flex min-h-screen w-full flex-col bg-muted/40'>
        ...
        <header className='sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[100px]:h-[10px]'>
          <Sheet>
            ...
            <SheetContent side="left" className="sm:max-w-xs">
              <nav className='grid gap-6 text-lg font-medium'>
                ...
                <Link href="#" className={`flex items-center gap-4 px-2.5 ${active === "Add Skill" ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`} onClick={() => setActive("Add Skill")}>
                  <PencilRuler className='h-5 w-5'/>
                  Add Skill
                </Link>
                ...
                <Link href="#" className={`flex items-center gap-4 px-2.5 text-muted-foreground hover:text-foreground`} onClick={() => setActive(handleLogout)}>
                  <LogOut className='h-5 w-5'/>
                  Logout
                </Link>
              </nav>
          ...
          <div className='flex items-center gap-4 md:grow-0 sm:ml-8 m:mt-2'>
            <img src={user && user.avatar && user.avatar.url} alt="avatar" className='border border-red-500 w-1 h-1 rounded-full max-[600px]:hidden' />
